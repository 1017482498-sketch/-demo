    ...
    <div className="flex flex-col min-h-full bg-[#f8fafc] pb-32 isolate">
      ...
      <header className="h-14 flex items-center bg-white sticky top-0 z-[999] border-b border-gray-50 px-4">
        ...
        <div className="flex-1 text-center">
          <h1 className="text-lg font-bold text-gray-900">产品详情</h1>
        </div>
      ...
      <div className="px-4 pt-6 space-y-8">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900">环宇盈活储蓄保险计划</h2>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-50">
          <h3 className="text-base font-bold text-gray-900 mb-5">产品概要</h3>
          <div className="space-y-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-50 overflow-hidden">
          <div className="px-6 py-5 flex items-center justify-between">
            <h3 className="text-base font-bold text-gray-900">产品亮点</h3>
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="bg-gray-50/80 rounded-2xl p-6 space-y-4">
              <div className="flex justify-center">
                <div className="bg-white px-6 py-2.5 rounded-lg border border-gray-100 shadow-sm text-xs font-bold text-gray-700">
                  主要受益人（100%）
                </div>
              </div>
              <div className="flex justify-between space-x-4">
                <div className="flex-1 bg-white py-2.5 rounded-lg border border-gray-100 shadow-sm text-xs font-bold text-center text-gray-700">
                  第一顺位（50%）
                </div>
                <div className="flex-1 bg-white py-2.5 rounded-lg border border-gray-100 shadow-sm text-xs font-bold text-center text-gray-700">
                  第二顺位（50%）
        ...
        <p className="text-[10px] text-gray-300 text-center px-8 leading-relaxed py-8">
      ...
      <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t border-gray-100 p-4 pb-6 flex space-x-4 z-[100] shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
        <button className="flex-1 bg-blue-600 text-white py-4 rounded-xl font-bold text-base active:bg-blue-700 transition-colors">
          咨询顾问
        </button>
        <button 
          onClick={() => navigate('/reservation')}
          className="flex-1 bg-white text-blue-600 border border-blue-600 py-4 rounded-xl font-bold text-base active:bg-blue-50 transition-colors"
        >
          预约投保
        </button>
      </div>
