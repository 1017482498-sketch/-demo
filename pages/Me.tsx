...
const Me: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-full bg-[#f8fafc] pb-10">
      {/* 1. 蓝色渐变头部 */}
      <div className="bg-gradient-to-br from-[#4facfe] to-[#4965ef] pt-12 pb-16 px-6 rounded-b-[40px] shadow-lg shadow-blue-500/20">
        <div className="flex flex-col items-center text-center">
          {/* 头像 */}
          <div className="w-24 h-24 rounded-full border-4 border-white/30 overflow-hidden mb-4 shadow-inner">
            <img 
          ...
          <div className="flex items-center space-x-2 mb-1">
            ...
            <span className="px-2 py-0.5 bg-white/20 backdrop-blur-md rounded-md text-[10px] text-white font-bold border border-white/10 uppercase">
              黄金会员
            </span>
          </div>
      ...
      <div className="px-4 -mt-10 grid grid-cols-2 gap-4">
        ...
        <div className="bg-white p-6 rounded-[28px] shadow-xl shadow-gray-200/50 border border-gray-50 flex flex-col space-y-4">
          ...
          <span className="text-sm font-bold text-orange-500">处理中(1)</span>
        </div>
      </div>

      {/* 3. 我的服务 */}
      <div className="mt-8 px-4 space-y-4">
        <h3 className="px-1 text-lg font-bold text-gray-800">我的服务</h3>
      ...
      <div className="mt-8 px-4 space-y-4 pb-10">
        <h3 className="px-1 text-lg font-bold text-gray-800">设置与合规</h3>
        <div className="bg-white rounded-[28px] overflow-hidden shadow-sm border border-gray-50">
